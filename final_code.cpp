...
#include <time.h>
#define MAX 10
char az[100],by[100],cx[1000000],pr,ne[100],ii=1;
int A[MAX],B[MAX];
int topA = -1;
int topB = -1;
int pi,ci,bc;
...
void game()
{
            ...
            while(1)
            {
                        ...
                        printf("\n=>1.Take an Element into box A");
                        printf("\n=>2.Take an Element into box B");
                        printf("\n=>3.START GAME");
                        printf("\n=>4.Check who is luckier");
                        printf("\n=>5.Exit");
                        printf("\nEnter your choice: ");
                        scanf("%d", &choice);
                        switch(choice)
                        {
                                    case 1: if(an!=0)
                                           {
									        printf("\nEnter an element to be taken into A: ");
                                            scanf("%d", &itemA);
                                            push_to_A(itemA);
                                            an=an-1;
                                    ...
                                    case 2: if(bn!=0)
                                    		{
									        printf("\nEnter an element to be taken into B: ");
                                            scanf("%d", &itemB);
                                            push_to_B(itemB);
                                            bn=bn-1;
                                    ...
                                    case 3:	
										    ...
										    {
										    	printf("CALCULATIONS ABOUT YOUR LUCKINESS ARE DONE\n");
...
void getin()
{
	...
	if(pi==dc)
	{
		...
		printf("1:Add data to your book\n");
		printf("2:Create new book\n");
		printf("3:Clear data from your book\n");
		printf("4:To show data in the your\n");
		printf("5:EXIT\n");
		printf("DATA ONCE dELETED WILLN'T BE BACK UP\n");
		scanf("%d",&pc);
		switch(pc)
		{
		case 1: addinfo();
...
void deldata()
{
    ...
    printf("@@@ WELCOME @@@\n");
    f=fopen("D:\\Diary.txt","w");
    printf("CLEARED DATA IN YOUR BOOK\n");
